...
SELECT DISTINCT t.id, t.name, t.color, t.description, t.usage_count, t.created_at
FROM tags t
...
func (q *Queries) GetRecentlyUsedTags(ctx context.Context, arg GetRecentlyUsedTagsParams) ([]Tag, error) {
